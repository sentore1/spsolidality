...
export default function AboutPage() {
  ...
  const partnersSection = sections.about_partners;
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[400px] overflow-hidden" style={{background: 'linear-gradient(135deg, #313194, #2a2b7e, #1e1f6b)'}}>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <svg className="w-7 h-7 mt-1 flex-shrink-0" style={{color: '#313194'}} fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/></svg>
        ...
        <div className="bg-gray-50 rounded-xl p-16 mb-32">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-[#313194] rounded-full flex items-center justify-center mx-auto mb-6">
      ...
      <div className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-5xl font-bold text-gray-900 mb-4">{partnersSection?.title[locale] || t('ourPartners')}</h2>
            <div className="w-20 h-1 bg-[#313194] mx-auto mb-6"></div>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {partnersSection?.content[locale] || t('partnersDesc')}
            </p>
          </div>
          <div className="flex justify-center items-center gap-8 flex-wrap">
            {(partners.length > 0 ? partners : [
              { id: 1, name: 'UNHCR',     logo_url: '/partners/Unhcr.JPG',                                         website_url: null },
              { id: 2, name: 'SEGAL',     logo_url: '/partners/SEGAL.JPG',                                         website_url: null },
              { id: 3, name: 'Inkomoko',  logo_url: '/partners/Inkomoko.JPG',                                      website_url: null },
              { id: 4, name: 'World',     logo_url: '/partners/World.JPG',                                         website_url: null },
              { id: 5, name: 'Partner',   logo_url: '/partners/WhatsApp Image 2026-09-07 at 10.09.03 PM.jpeg',     website_url: null },
            ]).map((partner) => (
              <div key={partner.id} className="flex flex-col items-center gap-3">
                <div className="w-36 h-36 bg-white shadow-lg border border-gray-100 rounded-xl overflow-hidden flex items-center justify-center p-3 hover:shadow-xl transition-shadow">
                  {partner.website_url ? (
      ...
      {/* Contact Info Banner */}
      <div className="py-16" style={{backgroundColor: '#313194'}}>
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center gap-3">
              ...
              <div>
                <p className="text-white/80 text-sm font-medium uppercase tracking-wide mb-1">Our Offices</p>
                <p className="text-white text-sm">Southern Province, Kamonyi District, Rugarika Sector</p>
                <p className="text-white text-sm mt-1">Western Province, Rusizi District, Kamembe Sector</p>
              </div>
            </div>
            <div className="flex flex-col items-center gap-3">
              <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
              ...
              <div>
                <p className="text-white/80 text-sm font-medium uppercase tracking-wide mb-1">Email</p>
                <a href="mailto:info@spsolidarity.org" className="text-white hover:underline">info@spsolidarity.org</a>
              </div>
            </div>
            <div className="flex flex-col items-center gap-3">
              <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
              ...
              <div>
                <p className="text-white/80 text-sm font-medium uppercase tracking-wide mb-1">Phone</p>
                <a href="tel:+250786908562" className="text-white hover:underline">+250 786 908 562</a>
              </div>
            </div>
          </div>
        </div>
