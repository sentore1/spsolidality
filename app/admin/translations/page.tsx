    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 p-2 border rounded"
                />
                <button onClick={addNewLanguage} className="bg-[#313194] text-white px-4 py-2 rounded hover:bg-[#2a2b7e]">
                  Add
                </button>
              </div>
            </div>
        ...
        <div className="mb-6 flex justify-end">
          <button onClick={saveTranslations} className="bg-[#313194] text-white px-8 py-3 rounded-lg hover:bg-[#2a2b7e] font-bold text-lg shadow-lg">
        ...
        <div className="space-y-4">
          {filteredKeys.map((key) => (
            <div key={key} className="bg-white p-6 rounded-lg shadow">
              <h3 className="font-bold mb-4 text-[#313194]">{key}</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {languages.map(lang => (
                  <div key={lang} className="border-l-4 border-[#313194] pl-4">
