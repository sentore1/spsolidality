  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <button onClick={() => setShowForm(!showForm)} className="bg-[#313194] text-white px-6 py-2 rounded-lg">
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-lg mb-8">
          ...
          <button type="submit" className="bg-[#313194] text-white px-6 py-2 rounded-lg" disabled={uploading}>{uploading ? 'Uploading...' : editingPage ? 'Update' : 'Create'} Page</button>
        </form>
      )}
          ...
          <div key={page.id} className="bg-white p-6 rounded-lg shadow flex justify-between items-center">
            <div className="flex gap-4 items-center">
              ...
              <div>
                ...
                <span className={`inline-block px-2 py-1 rounded text-sm ${page.is_active ? 'bg-[#e8e8f5] text-[#313194]' : 'bg-gray-100 text-gray-800'}`}>
