    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#313194] mx-auto mb-4"></div>
    ...
    <div className="p-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="bg-[#313194] text-white px-6 py-2 rounded-lg hover:bg-[#2a2b7e] transition disabled:bg-gray-400"
        >
