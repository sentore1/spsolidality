        ...
        <div className="w-full md:max-w-2xl pb-12 md:pb-16">
          <div className="w-full">
            <div className="p-4 sm:p-6 md:p-8">
              <h1 className={`text-xl sm:text-2xl md:text-4xl font-bold mb-3 md:mb-4 transition-all duration-700 ease-out text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] ${
                !isAnimating ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'
              }`} dangerouslySetInnerHTML={{__html: slides[currentSlide].title}}>
              </h1>
              <p className={`text-sm md:text-lg mb-4 md:mb-6 transition-all duration-700 ease-out delay-200 text-gray-200 drop-shadow-[0_1px_3px_rgba(0,0,0,0.8)] ${
                !isAnimating ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'
              }`}>
